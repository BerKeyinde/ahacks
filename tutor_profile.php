...
<form action="index.php" method="POST">
	...
	<div class="jumbotron">
		<h4>Profile</h4>
		Name: <label><?php echo $first_name.' '.$last_name?></label>
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
		            <div class="input-group input-group">
		              <span class="input-group-addon">Username</span>
		              <input name ="username" type="text" class="form-control" placeholder="<?php echo $uid; ?>" value = "<?php echo $uid; ?>">
		            </div>
          		</div>
			</div>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
		            <div class="input-group input-group">
		              ...
		              <input name = "residential_address" type="text" class="form-control" placeholder="<?php echo $residential_address; ?>" value = "<?php echo $residential_address; ?>">
		            </div>
          		</div>
			</div>
			...
			<div class="col-sm-6">
				<div class="form-group">
		            <div class="input-group input-group">
		              ...
		              <input name = "contact_number" type="text" class="form-control" placeholder="<?php echo $contact; ?>" value = "<?php echo $contact; ?>">
		            </div>
          		</div>
			</div>
			...
			Birthdate
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
				            <select name = "bday_month" data-toggle="select" class="form-control select select-default select-sm">
				            	<?php
				            	$bmonth_string = "";
				            		if ($bday_month != 0) {
				            			switch ($bday_month) {
					...
					<div class="col-sm-3">
						<div class="form-group">
				            <select name = "bday_day" data-toggle="select" class="form-control select select-default select-sm">
					...
					<div class="col-sm-3">
						<div class="form-group">
				            <select name = "bday_year" data-toggle="select" class="form-control select select-default select-sm">
		...
		<div class="row">
			<div class="col-sm-6">
			<h7 style = "color: #26A65B;">Tagged Skills</h7>
				<div class="tagsinput-primary">
            <input type = "text" name="tagskills" class="tagsinput tagsinput-typeahead input-lg" value="<?php echo $skill_tags; ?>"/>
          </div>
			</div>
		</div><br>
		<button name = "update_infox" type="submit" class="btn btn-danger">Save</button>
	</div>
</form>
</div>